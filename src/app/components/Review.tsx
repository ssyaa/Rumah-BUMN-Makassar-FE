...
import { app } from "../../../firebase-config"; // Sesuaikan path kalau beda ya
...
const ReviewProduct = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            const docRef = doc(db, "personalContact", "ReviewProduk");
    ...
    return (
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            >
            Membuat konten review dengan mempromosikan dan memperkenalkan produk Anda.
            </motion.p>
